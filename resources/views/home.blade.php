...
@section('content')
    ...
    <div class="category-area-style-one shape-move rts-section-gap bg_image">
                        ...
                        <div class="swiper mySwiper-category-1">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/01.svg" alt="brand">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/02.svg" alt="brand">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/03.svg" alt="brand">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/04.svg" alt="brand">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/05.svg" alt="brand">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="category-style-one">
                                        <div class="icon">
                                            <img src="site-assets/images/category/06.svg" alt="brand">
                                        </div>
        ...
        <div class="shape-image">
            ...
            <div class="shape two" data-speed="0.04"><img src="site-assets/images/banner/shape/banner-shape02.svg" alt=""></div>
            <div class="shape three" data-speed="0.04"><img src="site-assets/images/banner/shape/banner-shape03.svg" alt=""></div>
        </div>
    </div>
    <!-- category area end -->
