    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{Form::open(['url'=>route('admin.student-feedback.add'),'method'=>'post','autocomplete'=>'off','files'=>true])}}
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                <label class="text-label">Name<span class="text-danger">*</span></label>
                                {{Form::text('name', '',['class' => 'form-control','required'=>'true','id'=>'name','placeholder'=>'Enter Name'])}}
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                <label class="text-label">Designation<span class="text-danger">*</span></label>
                                {{Form::text('designation', '',['class' => 'form-control','required'=>'true','id'=>'designation','placeholder'=>'Enter Designation'])}}
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                {{ Form::select('rating', $ratings, '',['class' => 'form-control', 'placeholder' => 'Select Rating','required'=>'true']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row">
