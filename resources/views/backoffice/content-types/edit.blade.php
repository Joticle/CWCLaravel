    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{Form::open(['url'=>route('admin.content-type.edit',$row->id),'method'=>'post','autocomplete'=>'off','files'=>true])}}
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                {{ Form::select('type', getContentList(), $row->type,['class' => 'form-control', 'placeholder' => 'Select Content Type','required'=>'true']) }}
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
