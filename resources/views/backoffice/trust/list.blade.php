        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.trust.add') }}" type="button" class="btn btn-primary btn-sm mt-3 mt-sm-0"><i
                                ...
                                @if ($data->count() > 0)
                                    @foreach ($data as $index => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('admin.trust.edit', $row->id) }}"
                                                        data-toggle="tooltip" title="Edit {{ $singular_name }}"
                                                        class="btn btn-primary shadow btn-xs sharp me-1"><i
                                                            class="fa fa-pencil"></i></a>
                                                    &nbsp;<a data-toggle="tooltip" title="Delete {{ $singular_name }}"
                                                        href="{{ route('admin.trust.delete', $row->id) }}"
